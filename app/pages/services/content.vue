...
useContentSeo(svc)
useServicePageSchema(svc, 'content')
  ...
  <div ref="page" class="detail-page">
    ...
    <section class="cta-section">
      ...
      <NuxtLink
        ...
        data-umami-event-location="service-content"
...
.faq-item { border: 0.5px solid #24272e; border-top: none; cursor: pointer; padding: 14px 12px; transition: background 0.2s; } /* top edge owned by .faq-label-cell's border-bottom */
